...
public class ArbeitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finalinput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* 인텐트 관련 */
                Intent intent = new Intent(ArbeitActivity.this, ComfirmActivity.class);
    ...
    public void asyncJson(String url, Map<String, Object> params){
        ...
        aq.ajax(url, params, JSONObject.class, new AjaxCallback<JSONObject>(){
            ...
            public void callback(String url, JSONObject json, AjaxStatus status) {
                ...
                if(json != null){ // json은 api 서버에서 받아온 스트링
